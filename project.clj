...
(defproject s4 "0.1.10-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.10.1"]
                 ...
                 [io.netty/netty-codec-http ~netty-version :scope :provided]
                 [io.netty/netty-codec ~netty-version :scope :provided]
                 [io.netty/netty-handler-proxy ~netty-version :scope :provided]
                 [io.netty/netty-handler ~netty-version :scope :provided]
                 [io.netty/netty-resolver-dns ~netty-version :scope :provided]
                 [io.netty/netty-resolver ~netty-version :scope :provided]
                 [io.netty/netty-transport-native-epoll ~netty-version :scope :provided]
                 [io.netty/netty-transport ~netty-version :scope :provided]
                 [io.replikativ/konserve "0.6.0-alpha2"]
                 [io.replikativ/superv.async "0.2.9"]
                 [com.arohner/uri "0.1.2"]
                 [org.clojure/data.xml "0.2.0-alpha6"]]
  :profiles {:test {:dependencies [[aleph "0.4.6"]
